            ...
            <div class="card-buttons">
                <div class="flexrow 1">
                    <div>
                        <div class="dice-roll">
                            <div class="dice-result">
                                <h4 class="dice-formula">${this.object.accuracyResult} Successes vs ${this.object.defense} defence</h4>
                                <h4 class="dice-formula">${postDefenceTotal} Extra Successes + ${this.object.power} power</h4>
                      ...
                      <div>
                          <div class="dice-roll">
                              <div class="dice-result">
                                  ...
                                  <h4 class="dice-formula">1 Base + ${postDefenceTotal} Extra Successes</h4>
